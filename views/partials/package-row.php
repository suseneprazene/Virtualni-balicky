...
$price_text = $pkg->price > 0 ? wc_price( $pkg->price ) : __( 'zdarma', 'virtualni-balicek' );
?>
<div class="dd-pkg-row <?php echo $pkg->active ? 'dd-active' : 'dd-inactive'; ?>" data-id="<?php echo esc_attr( $pkg->id ); ?>">
    <div class="dd-pkg-info">
        ...
        <span class="dd-pkg-meta">
            ...
            <?php printf( _n( '%d dokument', '%d dokumentů', $doc_count, 'virtualni-balicek' ), $doc_count ); ?>
        </span>
    </div>
    <div class="dd-pkg-actions">
        <label class="dd-toggle" title="<?php esc_attr_e( 'Aktivní/Neaktivní', 'virtualni-balicek' ); ?>">
        ...
        <button class="button dd-edit-pkg" data-id="<?php echo esc_attr( $pkg->id ); ?>"
            ...
            <?php _e( 'Upravit', 'virtualni-balicek' ); ?>
        </button>
